                                                ...
                                                <Grid item>
                                                    <Box mx={2} my={0} boxShadow={0}>
                                                        <TextField
                                                            ...
                                                            variant="outlined"
                                                        >
                                                            {appState.role === 'Admin' && <MenuItem key={'Admin'} value={'Admin'}>Admin</MenuItem>}
                                                            {appState.role === 'Admin' && <MenuItem key={'Coordinator'} value={'Coordinator'}>Coordinator</MenuItem>}
                                                            <MenuItem key={'Volunteer'} value={'Volunteer'}>Volunteer</MenuItem>
                                                            <MenuItem key={'Patient'} value={'Patient'}>Member</MenuItem>
                                                        </TextField>
                                                    </Box>
                                                </Grid>
                                            </Grid>
