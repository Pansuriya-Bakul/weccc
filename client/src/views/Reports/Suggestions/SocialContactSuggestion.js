		...
		return (
			<div>
				...
				{/* {this.props.reports.frequency_of_social_contacts_month_phone_computer[this.props.collection] == 0 && */
					this.props.reports.frequency_of_social_contacts_month_phone_computer && this.props.reports.frequency_get_together_family && this.props.reports.frequency_get_together_friends && this.props.reports.frequency_get_together_neighbours && this.props.reports.frequency_of_social_contacts_month_phone_computer[this.props.collection] !== undefined && (this.props.reports.frequency_get_together_family[this.props.collection] == "Yearly" || this.props.reports.frequency_get_together_family[this.props.collection] == "Never") &&
					...
					<Typography variant="body1" color="inherit" align="left" gutterBottom>
						<em><b>Seeing family and friends.</b></em>  Even if circumstances make it difficult to physically get together with people as often as you would like, think about different ways to show them you care. Phone calls, letters, messages and video are all good ways to reach out. You could also plan for virtual get-togethers. Can we help you get started?
					</Typography>
				}
				{/*  The quality of time with your social interactions with others is limited. */}
				{this.props.reports.QSC_QofL1_COMB && this.props.reports.QSC_QofL1_COMB[this.props.collection] !== undefined && this.props.reports.QSC_QofL1_COMB[this.props.collection] < 2 &&
					<Typography variant="body1" color="inherit" align="left" gutterBottom>
						<em><b>Quality time with others.</b></em> Everyone needs people in their lives they enjoy spending time with. Think about what steps you can take now so you can get more enjoyment out of spending time with people. Would you like us to help you develop a plan?
					</Typography>
				}
			</div>
		)
