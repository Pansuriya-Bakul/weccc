    ...
    render() {
        return (
            ...
            multiple hospitalizations HU_HNum_QofL2_SD > 1*/}
                {(
                    ...
                    <>
                        <Typography variant="body1" color="inherit" align="left" gutterBottom>
                            <em><b>Your health.</b></em>   If you feel concerned about your health generally, you may benefit from developing a plan and building a network of care that is responsive to all aspects of your physical, mental, social and spiritual health.
                ...
                {this.props.reports.HU_HNum_QofL2_SD && this.props.reports.HU_HNum_QofL2_SD[this.props.collection] !== undefined && this.props.reports.HU_HNum_QofL2_SD[this.props.collection] >= 2 && this.props.reports.HU_HNum_QofL2_SD[this.props.collection] !== 999 &&
                    <Typography display="block" variant="body1" color="inherit" align="left" gutterBottom>
                        <em><b>Problems  with pain.</b></em>    Regularly monitor pain and discomfort symptoms, and the circumstances in which they are better and worse.
                ...
                {this.props.reports.AD_QofL2_SD && this.props.reports.AD_QofL2_SD[this.props.collection] !== undefined && this.props.reports.AD_QofL2_SD[this.props.collection] >= 2 && this.props.reports.AD_QofL2_SD[this.props.collection] !== 999 &&
                    <Typography display="block" variant="body1" color="inherit" align="left" gutterBottom>
                        <em><b>Problems with anxiety or depression.</b></em>   Regularly monitor your physical and psychological symptoms, and circumstances in which they are better and worse.
            ...
            usual activities UA_QofL2_SD > 2*/}
                ...
                {(
                    (this.props.reports.M_QofL2_SD && this.props.reports.M_QofL2_SD[this.props.collection] !== undefined && this.props.reports.M_QofL2_SD[this.props.collection] >= 2 && this.props.reports.M_QofL2_SD[this.props.collection] !== 999) ||
                    (this.props.reports.PC_QofL2_SD && this.props.reports.PC_QofL2_SD[this.props.collection] !== undefined && this.props.reports.PC_QofL2_SD[this.props.collection] >= 2 && this.props.reports.PC_QofL2_SD[this.props.collection] !== 999) ||
                    (this.props.reports.UA_QofL2_SD && this.props.reports.UA_QofL2_SD[this.props.collection] !== undefined && this.props.reports.UA_QofL2_SD[this.props.collection] >= 2 && this.props.reports.UA_QofL2_SD[this.props.collection] !== 999)
                ) &&
                    <>
                        <Typography variant="body1" color="inherit" align="left" gutterBottom>
                            ...
                            {this.props.reports.UA_QofL2_SD && this.props.reports.UA_QofL2_SD[this.props.collection] !== undefined && this.props.reports.UA_QofL2_SD[this.props.collection] >= 2 && this.props.reports.UA_QofL2_SD[this.props.collection] !== 999 &&
                                <>
                                    {(this.props.reports.M_QofL2_SD && this.props.reports.M_QofL2_SD[this.props.collection] !== undefined && this.props.reports.M_QofL2_SD[this.props.collection] >= 2 && this.props.reports.M_QofL2_SD[this.props.collection] !== 999) ||
                                        (this.props.reports.PC_QofL2_SD && this.props.reports.PC_QofL2_SD[this.props.collection] !== undefined && this.props.reports.PC_QofL2_SD[this.props.collection] >= 2 && this.props.reports.PC_QofL2_SD[this.props.collection] !== 999) ? "," : null}
                ...
                {this.props.reports.access_to_family_doctor && this.props.reports.access_to_family_doctor[this.props.collection] !== undefined && this.props.reports.access_to_family_doctor[this.props.collection] === "No" &&
                    <Typography display="block" variant="body1" color="inherit" align="left" gutterBottom>
                        <em><b>Access to a primary care provider.</b></em> Having your own family doctor is good for your health! Would you like us to help you connect with a primary care provider who is right for you?
                    </Typography>
                }
            </div>
        )
