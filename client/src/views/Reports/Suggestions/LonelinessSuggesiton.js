			...
			<div>
				...
				{this.props.reports.PL_QofL1_COMB_often_count && this.props.reports.PL_QofL1_COMB_often_count[this.props.collection] !== undefined && this.props.reports.PL_QofL1_COMB_often_count[this.props.collection] > 0 && this.props.reports.PL_QofL1_COMB_often_count[this.props.collection] !== 999 &&
					<Typography variant="body1" color="inherit" align="left" gutterBottom>
						<em><b>Loneliness.</b></em> Everyone needs people in their lives they feel close to. Try meeting new people and maybe make new friends.  Join events that will help you connect with neighbours who share your interests, or start your own activity, and see who you meet.
					</Typography>
				}
				{/* You sometimes feel [you lack companions, left out, or isolated from others] */}
				{this.props.reports.PL_QofL1_COMB_sometimes_count && this.props.reports.PL_QofL1_COMB && this.props.reports.PL_QofL1_COMB_sometimes_count[this.props.collection] !== undefined && this.props.reports.PL_QofL1_COMB[this.props.collection] !== undefined && this.props.reports.PL_QofL1_COMB_sometimes_count[this.props.collection] > 0 && this.props.reports.PL_QofL1_COMB_sometimes_count[this.props.collection] !== 999 && this.props.reports.PL_QofL1_COMB[this.props.collection] >= 1.6 && this.props.reports.PL_QofL1_COMB[this.props.collection] !== 999 &&
					<Typography variant="body1" color="inherit" align="left" gutterBottom>
						<em><b>Loneliness.</b></em> Try connecting with others through sharing your time and talents with them. Invite others to join you in doing the activities you love best. Helping others is also a good way to feel less lonely.
					</Typography>
				}
