...
import SocialHealthSuggestion from './Suggestions/SocialHealthSuggestion';
	...
	render() {
		return (
            <>
                ...
                <SocialHealthSuggestion reports = {this.props.reports} collection = {this.props.collection}/>
